...
public class ErrorDialog extends AbsUnableCancelStatusDialog {
    ...
    public ErrorDialog(@NonNull Context context, CharSequence text) {
        super(context, text);
    }

    public ErrorDialog(@NonNull Context context, CharSequence text, long duration) {
    ...
    private View defaultView() {
        ...
        img.setImageResource(R.mipmap.icon_status_dialog_error);
        return img;
    }
}
