...
public class FailedDialog extends AbsUnableCancelStatusDialog {
    ...
    public FailedDialog(@NonNull Context context, CharSequence text) {
        super(context, text);
    }

    public FailedDialog(@NonNull Context context, CharSequence text, long duration) {
    ...
    private View defaultView() {
        ...
        img.setImageResource(R.mipmap.icon_status_dialog_failed);
        return img;
    }
}
