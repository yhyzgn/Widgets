...
import com.yhy.widget.core.loading.indicator.BallPulseIndicator;
...
public class LoadingView extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mMinWidth = a.getDimensionPixelSize(R.styleable.LoadingView_min_width, mMinWidth);
        mMaxWidth = a.getDimensionPixelSize(R.styleable.LoadingView_max_width, mMaxWidth);
        mMinHeight = a.getDimensionPixelSize(R.styleable.LoadingView_min_height, mMinHeight);
        mMaxHeight = a.getDimensionPixelSize(R.styleable.LoadingView_max_height, mMaxHeight);
        mIndicatorColor = a.getColor(R.styleable.LoadingView_indicator_color, Color.WHITE);
        String indicatorName = a.getString(R.styleable.LoadingView_indicator_name);
